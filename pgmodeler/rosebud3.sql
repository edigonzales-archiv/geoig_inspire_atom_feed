...
-- object: metadb_ng.online_service | type: TABLE --
-- DROP TABLE metadb_ng.online_service;
CREATE TABLE metadb_ng.online_service(
	ogc_fid serial,
	metadb_id character varying NOT NULL,
	uri character varying NOT NULL,
	CONSTRAINT metadb_ng_online_service_pkey PRIMARY KEY (ogc_fid)

);
-- ddl-end --
ALTER TABLE metadb_ng.online_service OWNER TO stefan;
-- ddl-end --
...
-- object: online_service_metadb_identifier_fkey | type: CONSTRAINT --
-- ALTER TABLE metadb_ng.online_service DROP CONSTRAINT online_service_metadb_identifier_fkey;
ALTER TABLE metadb_ng.online_service ADD CONSTRAINT online_service_metadb_identifier_fkey FOREIGN KEY (metadb_id)
REFERENCES metadb_ng.metadb (identifier) MATCH FULL
ON DELETE NO ACTION ON UPDATE NO ACTION;
-- ddl-end --


-- object: grant_62d40f4321 | type: PERMISSION --
GRANT USAGE
   ON SCHEMA metadb_ng
   TO mspublic;
-- ddl-end --

-- object: grant_1214f22d0a | type: PERMISSION --
GRANT SELECT
   ON TABLE metadb_ng.metadb
   TO mspublic;
-- ddl-end --

-- object: grant_436e5dbe3c | type: PERMISSION --
GRANT SELECT
   ON TABLE metadb_ng.type
   TO mspublic;
-- ddl-end --

-- object: grant_e4dc2015cc | type: PERMISSION --
GRANT SELECT
   ON TABLE metadb_ng.metadb_relation
   TO mspublic;
-- ddl-end --

-- object: grant_0c8bc21604 | type: PERMISSION --
GRANT SELECT
   ON TABLE metadb_ng.online_dataset
   TO mspublic;
-- ddl-end --

-- object: grant_5d53a1c41d | type: PERMISSION --
GRANT SELECT
   ON TABLE metadb_ng.online_service
   TO mspublic;
-- ddl-end --
